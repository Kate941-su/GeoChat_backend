...
// Initialize Firebase
var app = (0, app_1.initializeApp)(firebase_const_1.firebaseConfig);
// Get FireStore Instance
var firestore = (0, firestore_1.getFirestore)();
var specialOfTheDay = (0, firestore_1.doc)(firestore, "dailySpecial/2023-11-20");
// Create New Document.
function writeDailySpecail() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, firestore_1.setDoc)(specialOfTheDay, docData, { merge: true })
                            .then(function () {
...
var ordersCollection = (0, firestore_1.collection)(firestore, "orders");
// Add Document
function addANewDocument() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, firestore_1.addDoc)(ordersCollection, {
                        customer: "Auther",
                        drink: "Latte",
...
function readASingleDocument() {
    return __awaiter(this, void 0, void 0, function () {
        var mySnapshot, docData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, firestore_1.getDoc)(specialOfTheDay)];
                case 1:
                    mySnapshot = _a.sent();
...
var dailySpecialUnsubscribe;
var unsubscribeCustomerOrders;
function listenToADocument() {
    dailySpecialUnsubscribe = (0, firestore_1.onSnapshot)(specialOfTheDay, function (docSnampShot) {
...
function queryForDocuments() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                customerOrdersQuery = (0, firestore_1.query)((0, firestore_1.collection)(firestore, "orders"), (0, firestore_1.where)("drink", "==", "Latte"), (0, firestore_1.limit)(10));
            }
            catch (error) {
                console.log(error);
            }
            unsubscribeCustomerOrders = (0, firestore_1.onSnapshot)(customerOrdersQuery, function (querySnapshot) {
